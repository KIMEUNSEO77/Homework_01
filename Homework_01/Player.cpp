...
// 이 함수는 매 프레임마다 프레임워크에서 호출됨. 
// 플레이어의 속도 벡터에 중력과 마찰력 등을 적용하여 플레이어를 이동
void CPlayer::Update(float fTimeElapsed)
{
	...
	속도 벡터의 반대 방향 벡터를 구하고 단위 벡터로 만듦. 마찰 계수를 시간에 비례하도록 하여 마찰력을 구함. 
	단위 벡터에 마찰력을 곱하여 감속 벡터를 구함. 속도 벡터에 감속 벡터를 더하여 속도 벡터를 줄임.
	마찰력이 속력보다 크면 속력은 0이 될 것.*/
...
{
	// 플레이어의 위치과 방향 벡터로 부터 따라 월드 변환 행렬을 구함
	OnUpdateTransform();
